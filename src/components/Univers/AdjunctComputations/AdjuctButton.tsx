...
export default function AdjunctButton(props: Props){
    ...
    return(
        ...
        {buttonClicked ? <ConstantAdjunct handleClick={handleClick} UniverseRef={props.UniverseRef} params={props.params} handleSelect={props.handleSelect} selectValue={props.selectValue}/> : null}
        </>
    )
}